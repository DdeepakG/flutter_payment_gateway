...
class Home extends StatelessWidget {
  ...
  final String login = "317159"; //merchant id, mandatory
  ...
  final String txnid =
      'test000123'; // mandatory // this should be unique each time
  ...
  final String custFirstName = 'Deepak'; //optional
  final String custLastName = 'G'; //optional
  final String mobile = '8510889066'; //optional
  final String email = 'dgupta@gmail.com'; //optional
  final String address = 'delhi'; //optional
  ...
  _getAtomTokenId(context, authEncryptedString) async {
    ...
    var request = http.Request(
        'POST', Uri.parse("https://paynetzuat.atomtech.in/ots/aipay/auth"));
